    ...
    <div class="mx-auto max-w-6xl">
        <div class="rounded-xl border bg-white shadow-sm">
            ...
            <div class="border-b px-6 py-4">
                <h2 class="text-lg font-semibold">Attendance Message Templates</h2>
                <p class="mt-1 text-sm text-gray-500">
                    Create custom messages for Arrival/Departure.
                </p>
            </div>

            <form method="POST" action="{{ route('attendance-templates.store') }}" x-data="tplForm()" class="p-6 space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-9">
                        ...
                        <!-- Placeholder chips (styled like your weekday buttons) -->
    ...
    <script>
        function tplForm(){
            return {
                ...
                previewText: '',
                placeholders: [
                    'student_name','father_name','class_name','date_time','school_name'
                ],
                insert(ph){
